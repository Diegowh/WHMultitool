...
class MFRetrieveGUI(ConfigurableFrame):
    
    def __init__(self, mf_retrieve: 'MFRetrieve', master, mf_controller):
        super().__init__(master)
        
        self.master = master
        self.mf_controller = mf_controller
        self.service_controller = mf_retrieve
    ...
    def destroy_gui(self):
        ...
        super().destroy()
        print("Magic-F -> Retrieve, destroyed")
