...
class BreederManager:
    ...
    def __init__(self, config: Config) -> None:
        ...
        self.gui = BreederManagerGUI(breeder_manager=self, config=self.config)
        self.gui.mainloop()
...
class BreederManagerGUI(tk.Tk):
    ...
    def __init__(self, breeder_manager: BreederManager, config: Config) -> None:
        super().__init__()
...
if __name__ == "__main__":
    config = Config()
    app = BreederManager(config=config)